...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Extra Credit:
    #The number in the () is the starting number of the first variable and then
    #it enumerates over the array giving you the final result. So for result it
    # does 0+2+3+4=9 and for result2 its 1*2*3*4=24.
  end
  ...
  #   # code to read 'file'
  # So that you aren't created unneccesary objects and variables.
  #
